                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            {{-- @foreach ($product->productAttributes->groupBy('attribute_id') as $attributeProducts)
                                                ...
                                                <legend class="product__variant--title mb-8">
                                                    {{ $attributes->attribute->name }}</legend>

                                                <ul class="variant__size d-flex">
                                                    @foreach ($attributeProducts as $attribute)
                                                        <li class="variant__size--list">
                                                            <input id="color-{{ $attribute->id }}" name="value"
                                                                type="radio" value="{{ $attribute->value }}" checked>
                                                            @if ($attributes->attribute->name === 'Màu sắc')
                                                                <label class="variant__size--value"
                                                                    for="color-{{ $attribute->id }}"
                                                                    style="background: {{ $attribute->value }};"></label>
                                                            @else
                                                                <label
                                                                    class="variant__size--value">{{ $attribute->value }}</label>
                                                            @endif
                                                        </li>
                                                    @endforeach
                                                </ul>
                                ...
                                <div class="product__items ">
                                    ...
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link"
                                            href="{{ route('productDetail', ['category_id' => $productSimilar->categories->first()->id, 'id' => $productSimilar->id, 'slug' => $productSimilar->slug]) }}">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ Storage::url($productSimilar->img_thumbnail) }}"
                                                alt="product-img">
