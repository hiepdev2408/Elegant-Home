...
<main class="main__content_wrapper">
    ...
    <section class="shop__section section--padding">
        <div class="container-fluid">
            <div class="row">
                @include('client.shops.sidebars.sidebar-left',['categories' => $categories, 'productnew' => $productnew])
                                       ...
                                       <div class="col mb-30">
                                        <div class="product__items ">
                                            ...
                                            <div class="product__items--content text-center">
                                                ...
                                                <h3 class="product__items--content__title h4"><a href="{{ route('productDetail', ['slug' => $product->slug]) }}">{{$product->name}}</a></h3>
                                            ...
                                            <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                <div class="product__list--items__left d-flex align-items-center">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        ...
                                                        <h4 class="product__list--items__content--title mb-15"><a href="product-details.html">{{$product->name}}</a></h4>
                                                        <p class="product__list--items__content--desc m-0">{{$product->description}}</p>
                                                    </div>
                                                </div>
                                                <div class="product__list--items__right">
                                                    <span class="product__list--current__price">{{$product->base_price}}</span>
