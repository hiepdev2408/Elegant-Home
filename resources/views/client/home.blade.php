    ...
    <div class="auto-container">
        ...
        <div class="four-item-carousel owl-carousel owl-theme">
            ...
            <div class="shop-item">
                <div class="inner-box">
                    <div class="image">
                        <a href="shop-detail.html"><img src="{{ asset('themes/clients/images/resource/products/1.png') }}"
                                alt="" /></a>
            ...
            <div class="shop-item">
                <div class="inner-box">
                    <div class="image">
                        <a href="shop-detail.html"><img src="{{ asset('themes/clients/images/resource/products/2.png') }}"
                                alt="" /></a>
                        <span class="tag flaticon-heart"></span>
                        <div class="cart-box text-center">
                            <a class="cart" href="#">Add to Cart</a>
            ...
            <div class="shop-item">
                <div class="inner-box">
                    <div class="image">
                        <a href="shop-detail.html"><img src="{{ asset('themes/clients/images/resource/products/3.png') }}"
                                alt="" /></a>
                        <span class="tag flaticon-heart"></span>
                        <div class="cart-box text-center">
                            <a class="cart" href="#">Add to Cart</a>
            ...
            <div class="shop-item">
                <div class="inner-box">
                    <div class="image">
                        <a href="shop-detail.html"><img src="{{ asset('themes/clients/images/resource/products/4.png') }}"
                                alt="" /></a>
                        <span class="tag flaticon-heart"></span>
                        <div class="cart-box text-center">
                            <a class="cart" href="#">Add to Cart</a>
                        ...
                        <div class="product-block-four col-lg-3 col-md-6 col-sm-6">
                            <div class="inner-box d-flex justify-content-between align-items-center flex-wrap">
                                <div class="image">
                                    ...
                                    <img src="{{ asset('themes/clients/images/resource/product-1.png') }}" alt="" />
                                </div>
                                <div class="content">
                        ...
                        <div class="product-block-four col-lg-3 col-md-6 col-sm-6">
                            <div class="inner-box d-flex justify-content-between align-items-center flex-wrap">
                                <div class="image">
                                    ...
                                    <img src="{{ asset('themes/clients/images/resource/product-2.png') }}" alt="" />
                                </div>
                                <div class="content">
                                    <h6><a href="shop-detail.html">Full Sleeve Cotton</a></h6>
                                    <div class="total-products">(312 Product)</div>
                        ...
                        <div class="product-block-four col-lg-3 col-md-6 col-sm-6">
                            <div class="inner-box d-flex justify-content-between align-items-center flex-wrap">
                                <div class="image">
                                    ...
                                    <img src="{{ asset('themes/clients/images/resource/product-3.png') }}" alt="" />
                                </div>
                                <div class="content">
                        ...
                        <div class="product-block-four col-lg-3 col-md-6 col-sm-6">
                            <div class="inner-box d-flex justify-content-between align-items-center flex-wrap">
                                <div class="image">
                                    ...
                                    <img src="{{ asset('themes/clients/images/resource/product-4.png') }}" alt="" />
                                </div>
                                <div class="content">
                        ...
                        <div class="product-block-four col-lg-3 col-md-6 col-sm-6">
                            <div class="inner-box d-flex justify-content-between align-items-center flex-wrap">
                                <div class="image">
                                    ...
                                    <img src="{{ asset('themes/clients/images/resource/product-5.png') }}" alt="" />
                                </div>
                                <div class="content">
                                    <h6><a href="shop-detail.html">Full Sleeve Cotton</a></h6>
                                    <div class="total-products">(312 Product)</div>
                        ...
                        <div class="product-block-four col-lg-3 col-md-6 col-sm-6">
                            <div class="inner-box d-flex justify-content-between align-items-center flex-wrap">
                                <div class="image">
                                    ...
                                    <img src="{{ asset('themes/clients/images/resource/product-6.png') }}" alt="" />
                                </div>
                                <div class="content">
                                    <h6><a href="shop-detail.html">Full Sleeve Cotton</a></h6>
                        ...
                        <div class="product-block-four col-lg-3 col-md-6 col-sm-6">
                            <div class="inner-box d-flex justify-content-between align-items-center flex-wrap">
                                <div class="image">
                                    ...
                                    <img src="{{ asset('themes/clients/images/resource/product-7.png') }}" alt="" />
                                </div>
                                <div class="content">
                                    <h6><a href="shop-detail.html">Monkey Red Caps</a></h6>
                                    <div class="total-products">(213 Product)</div>
                        ...
                        <div class="product-block-four col-lg-3 col-md-6 col-sm-6">
                            <div class="inner-box d-flex justify-content-between align-items-center flex-wrap">
                                <div class="image">
                                    ...
                                    <img src="{{ asset('themes/clients/images/resource/product-8.png') }}" alt="" />
                                </div>
                                <div class="content">
                                    <h6><a href="shop-detail.html">Men,s Cotton Pant</a></h6>
                                    <div class="total-products">(461 Product)</div>
...
<section class="collection-section">
    <div class="auto-container">
        <div class="inner-container">
            <div class="pattern-layer" style="background-image: url({{ asset('themes/clients/images/icons/pattern-1.png') }})"></div>
            <div class="shape-layer" style="background-image: url({{ asset('themes/clients/images/background/pattern-1.png') }})"></div>
            <div class="row clearfix">
                ...
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="image">
                        <div class="shadow-layer" style="background-image: url({{ asset('themes/clients/images/icons/pattern-2.png') }})">
                        </div>
    ...
    <div class="auto-container">
        ...
        <div class="mixitup-gallery">
            ...
            <div class="filters">
                ...
                <!-- Đổ dữ liệu danh mục con ra phần này -->
            ...
            <div class="filter-list row clearfix">
                @include('client.layouts.partials.filter')
            </div>
        ...
        <div class="inner-container">
            <div class="sponsors-outer">
                ...
                <ul class="sponsors-carousel owl-carousel owl-theme">
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{ asset('themes/clients/images/clients/1.png') }}"
                                    alt=""></a>
                        </figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{ asset('themes/clients/images/clients/2.png') }}"
                                    alt=""></a>
                        </figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{ asset('themes/clients/images/clients/3.png') }}"
                                    alt=""></a>
                        </figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{ asset('themes/clients/images/clients/4.png') }}"
                                    alt=""></a>
                        </figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{ asset('themes/clients/images/clients/5.png') }}"
                                    alt=""></a>
                        </figure>
                    </li>
                    <li class="slide-item">
        ...
        <div class="news-carousel owl-carousel owl-theme">
            ...
            <div class="news-block">
                <div class="inner-box">
                    <div class="image">
                        ...
                        <a href="blog-detail.html"><img src="{{ asset('themes/clients/images/resource/news-1.jpg') }}"
                                alt="" /></a>
                    </div>
                    <div class="lower-content">
                        <div class="author">
            ...
            <div class="news-block">
                <div class="inner-box">
                    <div class="image">
                        <div class="tag">bedroom</div>
                        <a href="blog-detail.html"><img src="{{ asset('themes/clients/images/resource/news-2.jpg') }}"
                                alt="" /></a>
                    </div>
                    <div class="lower-content">
                        <div class="author">
...
<section class="testimonial-section">
    <div class="pattern-layer" style="background-image: url({{ asset('themes/clients/images/background/pattern-3.png') }})"></div>
    <div class="auto-container">
        <div class="inner-container">
            <div class="pattern-layer-two" style="background-image: url({{ asset('themes/clients/images/background/pattern-4.png') }})">
            </div>
            <div class="vector-layer" style="background-image: url({{ asset('themes/clients/images/background/pattern-2.png') }})"></div>
            <div class="single-item-carousel owl-carousel owl-theme">
                            ...
                            <div class="image-column col-lg-4 col-md-12 col-sm-12">
                                <div class="inner-column">
                                    <div class="arrow-layer"
                                        style="background-image: url({{ asset('themes/clients/images/icons/arrow-2.png') }})"></div>
                                    <div class="image">
                                        <img src="{{ asset('themes/clients/images/resource/author-2.jpg') }}" alt="" />
                                        <!-- Social Box -->
                                        <ul class="social-box">
