            ...
            <div class="row mb--n28">
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                ...
                                src="{{ asset('themes') }}/client/img/banner/banner1.webp" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                class="banner__items--thumbnail__img"
                                src="{{ asset('themes') }}/client/img/banner/banner2.webp" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                class="banner__items--thumbnail__img"
                                src="{{ asset('themes') }}/client/img/banner/banner3.webp" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items mb-25">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                class="banner__items--thumbnail__img"
                                src="{{ asset('themes') }}/client/img/banner/banner4.webp" alt="banner-img">
                    ...
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                class="banner__items--thumbnail__img"
                                src="{{ asset('themes') }}/client/img/banner/banner5.webp" alt="banner-img">
    ...
    <section class="product__section section--padding pt-0">
        <div class="container-fluid">
            ...
            <ul class="product__tab--btn d-flex justify-content-center mb-50">
                ...
                <li class="product__tab--btn__list {{ $key === 0 ? 'active' : '' }}" data-toggle="tab" data-target="#{{ strtolower(str_replace(' ', '-', $item->name)) }}">
                    {{ $item->name }}
                </li>
                @endforeach
            </ul>
            ...
            <div class="tab_content">
                @foreach($categories as $key => $item)
                <div id="{{ strtolower(str_replace(' ', '-', $item->name)) }}" class="tab_pane {{ $key === 0 ? 'active' : '' }} show">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="{{ route('productDetail', ['slug' => $product->slug]) }}">
                                    ...
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('themes') }}/client/img/product/product5.webp"
                                                alt="product-img">
                                            <img class="product__items--img product__secondary--img"
                                                src="{{ asset('themes') }}/client/img/product/product6.webp"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('themes') }}/client/img/product/product11.webp"
                                                alt="product-img">

                                            <img class="product__items--img product__secondary--img"
                                                src="{{ asset('themes') }}/client/img/product/product12.webp"
                                                alt="product-img">
                                        </a>
                                        <ul class="product__items--action d-flex justify-content-center">
                                            <li class="product__items--action__list">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('themes') }}/client/img/product/product13.webp"
                                                alt="product-img">
                                            <img class="product__items--img product__secondary--img"
                                                src="{{ asset('themes') }}/client/img/product/product14.webp"
                                                alt="product-img">
                                        </a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">New</span>
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('themes') }}/client/img/product/product15.webp"
                                                alt="product-img">
                                            <img class="product__items--img product__secondary--img"
                                                src="{{ asset('themes') }}/client/img/product/product1.webp"
                                                alt="product-img">
                                        </a>
                                        <ul class="product__items--action d-flex justify-content-center">
                                            <li class="product__items--action__list">
                                    ...
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                ...
                                                alt="product-img">
                                            <img class="product__items--img product__secondary--img"
                                                src="{{ asset('themes') }}/client/img/product/product2.webp"
                                                alt="product-img">
                                        </a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">New</span>
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('themes') }}/client/img/product/product3.webp"
                                                alt="product-img">
                                            <img class="product__items--img product__secondary--img"
                                                src="{{ asset('themes') }}/client/img/product/product4.webp"
                                                alt="product-img">
                                        </a>
                                        <ul class="product__items--action d-flex justify-content-center">
                                            <li class="product__items--action__list">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('themes') }}/client/img/product/product7.webp"
                                                alt="product-img">
                                            <img class="product__items--img product__secondary--img"
                                                src="{{ asset('themes') }}/client/img/product/product8.webp"
                                                alt="product-img">
                                        </a>
                                        <ul class="product__items--action d-flex justify-content-center">
                                            <li class="product__items--action__list">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('themes') }}/client/img/product/product9.webp"
                                                alt="product-img">
                                            <img class="product__items--img product__secondary--img"
                                                src="{{ asset('themes') }}/client/img/product/product10.webp"
                                                alt="product-img">
                                        </a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">New</span>
            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n28">
                <div class="col mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                class="banner__items--thumbnail__img"
                                src="{{ asset('themes') }}/client/img/banner/banner6.webp" alt="banner-img">
                ...
                <div class="col mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                class="banner__items--thumbnail__img"
                                src="{{ asset('themes') }}/client/img/banner/banner7.webp" alt="banner-img">
                            <div class="banner__items--content__style2 right">
                ...
                <div class="col mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                class="banner__items--thumbnail__img"
                                src="{{ asset('themes') }}/client/img/banner/banner8.webp" alt="banner-img">
            ...
            <div class="row">
                    ...
                    <div class="product__section--wrapper">
                        <div class="section__heading style2 position__relative border-bottom mb-35">
                            ...
                            <img class="section__heading--position__img"
                                src="{{ asset('themes') }}/client/img/other/heading-shape-img.webp"
                                ...
                                <div class="col mb-25">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content style2 position__relative">
                                            ...
                                            <a class="product__cart--btn__style2 primary__btn" href="cart.html"> Add
                                                to cart </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4 offset-xl-0 col-lg-6 offset-lg-3 col-md-8  product__col--width__4">
                    <div class="deals__banner--thumbnail">
                        <a class="deals__banner--thumbnail__link display-block position__relative"
                            href="shop.html"><img class="deals__banner--thumbnail__img display-block"
                                src="{{ asset('themes') }}/client/img/banner/banner9.webp"
                            ...
                            <div class="deals__banner--content text-center">
                                <h2 class="deals__banner--content__maintitle h3">Bring Beauty With <br>
                                    Furniture Tree </h2>
                                <div class="deals__banner--countdown d-flex justify-content-center"
        ...
        <div class="container-fluid">
            <div class="banner__video--thumbnail position__relative">
                <img class="banner__video--thumbnail__img display-block"
                    src="{{ asset('themes') }}/client/img/banner/banner-bg1.webp" alt="banner-bideo-thumbnail">
            ...
            <div class="shipping__section--inner border-radius-10 d-flex justify-content-center">
                <div class="shipping__items text-center">
                    <div class="shipping__items--icon">
                        <svg id="Group_118" data-name="Group 118" xmlns="http://www.w3.org/2000/svg"
                            width="38.02" height="41.512" viewBox="0 0 38.02 41.512">
                ...
                <div class="col col-lg-order">
                    <div class="testimonial__banner--thumbnail">
                        <a class="display-block" href="shop.html"><img
                                ...
                                src="{{ asset('themes') }}/client/img/banner/banner10.webp" alt="banner-img"></a>
                    </div>
                </div>
                <div class="col">
                                        ...
                                        <div class="testimonial__items--topbar d-flex align-items-center">
                                            <div class="testimonial__items--thumbnail">
                                                <img class="testimonial__items--thumbnail__img display-block"
                                                    src="{{ asset('themes') }}/client/img/other/testimonial-thumb1.webp"
                                                    alt="testimonial-img">
                                            </div>
...
>>>>>>> 5afeb7f6b93fdc036edcec014d50d666f55a6e44
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    ...
                                    src="{{ asset('themes') }}/client/img/banner/banner1.webp" alt="banner-img">
                                <div class="banner__items--content one">
                                    <h2 class="banner__items--content__title">Sofa đơn tối giản<br>
                                        Sofa kết hợp </h2>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    ...
                                    src="{{ asset('themes') }}/client/img/banner/banner2.webp" alt="banner-img">
                                <div class="banner__items--content two">
                                    <h2 class="banner__items--content__title">Phong cách hiện đại <br>
                                        Sofa đơn</h2>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    ...
                                    src="{{ asset('themes') }}/client/img/banner/banner3.webp" alt="banner-img">
                                <div class="banner__items--content three">
                                    <h2 class="banner__items--content__title">Lớn hơn Tối giản <br>
                                        Ghế gỗ </h2>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                        <div class="banner__items mb-25">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    ...
                                    src="{{ asset('themes') }}/client/img/banner/banner4.webp" alt="banner-img">
                                <div class="banner__items--content four">
                                    <h2 class="banner__items--content__title four">Gói gia đình <br>
                                        Bộ ghế sofa</h2>
                                </div>
                            </a>
                        </div>
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    ...
                                    src="{{ asset('themes') }}/client/img/banner/banner5.webp" alt="banner-img">
                                <div class="banner__items--content five">
                                    <h2 class="banner__items--content__title">Sofa Combo Tối Giản Màu Trắng <br>
                                        Sofa Combo Tối Giản Màu Trắng</h2>
                                </div>
                            </a>
                        </div>
                    </div>
        ...
        <section class="product__section section--padding pt-0">
            <div class="container-fluid">
                <div class="section__heading text-center mb-30">
                    <h2 class="section__heading--maintitle">Các mặt hàng phổ biến nhất</h2>
                </div>

                <ul class="product__tab--btn d-flex justify-content-center mb-50">
                    @foreach ($categories as $key => $item)
                        <li class="product__tab--btn__list {{ $key === 0 ? 'active' : '' }}" data-toggle="tab"
                            data-target="#{{ strtolower(str_replace(' ', '-', $item->name)) }}">
                            {{ $item->name }}
                        </li>
                    @endforeach
                </ul>
                ...
                <div class="tab_content">
                    @foreach ($categories as $key => $item)
                        <div id="{{ strtolower(str_replace(' ', '-', $item->name)) }}"
                            class="tab_pane {{ $key === 0 ? 'active' : '' }} show">
                            <div class="product__section--inner">
                                <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                                    @foreach ($item->products as $product)
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                ...
                                                <div class="product__items--content text-center">
                                                    ...
                                                    <div class="product__items--price">
                                                        <span
                                                            class="current__price">{{ number_format($product->base_price, 0, ',', '.') }}
                                                            VNĐ
                                                        </span>
                                                        <span class="old__price"></span>
                                                    </div>
                    ...
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    class="banner__items--thumbnail__img"
                                    src="{{ asset('themes') }}/client/img/banner/banner6.webp" alt="banner-img">
                                <div style="margin-right: -20px" class="banner__items--content__style2 right">
                                    <h2 class="banner__items--content__style2--title">Đơn giản <br>
                                        Ghế Mini </h2>
                                    <span class="banner__items--content__link primary__btn style2">Đặt hàng ngay</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    ...
                                    src="{{ asset('themes') }}/client/img/banner/banner7.webp" alt="banner-img">
                                <div class="banner__items--content__style2 right">
                                    <h2 class="banner__items--content__style2--title">Nội thất mới <br>
                                        Hành tinh cây </h2>
                                    <span class="banner__items--content__link primary__btn style2">Đặt hàng ngay</span>
                                </div>
                            </a>
                    ...
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    class="banner__items--thumbnail__img"
                                    src="{{ asset('themes') }}/client/img/banner/banner8.webp" alt="banner-img">
                                <div style="margin-left: -20px" class="banner__items--content__style2">
                                    <h2 class="banner__items--content__style2--title">Đơn giản <br>
                                        Ghế Mini </h2>
                                    <span class="banner__items--content__link primary__btn style2">Đặt hàng ngay</span>
                                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-8 col-12 product__col--width__8">
                        <div class="product__section--wrapper">
                            <div class="section__heading style2 position__relative border-bottom mb-35">
                                <h2 class="section__heading--maintitle">Đồ nội thất bằng gỗ</h2>
                                <img class="section__heading--position__img"
                                    src="{{ asset('themes') }}/client/img/other/heading-shape-img.webp"
                                    alt="heading-shape-img">
                            </div>
                                        ...
                                        <div class="col mb-25">
                                            <div class="product__items">
                                                ...
                                                <div class="product__items--content style2 position__relative">
                                                    ...
                                                    <a class="product__cart--btn__style2 primary__btn" href="cart.html">
                                                        Add
                                                        to cart </a>
                                                </div>
                                            </div>
                    ...
                    <div class="col-xl-4 offset-xl-0 col-lg-6 offset-lg-3 col-md-8  product__col--width__4">
                        <div class="deals__banner--thumbnail">
                            <a class="deals__banner--thumbnail__link display-block position__relative"
                                href="shop.html"><img class="deals__banner--thumbnail__img display-block"
                                    src="{{ asset('themes') }}/client/img/banner/banner9.webp" alt="deals-thumbnail-img">
                                <div class="deals__banner--content text-center">
                                    <h2 class="deals__banner--content__maintitle h3">Bring Beauty With <br>
                                        Furniture Tree </h2>
                                    <div class="deals__banner--countdown d-flex justify-content-center"
                                        ...
                                        <div class="testimonial__items">
                                            ...
                                            <div class="testimonial__items--content">
                                                <svg class="testimonial__icon--svg" data-name="Group 546"
                                                    xmlns="http://www.w3.org/2000/svg" width="21.479" height="18.939"
                                                ...
                                                <p class="testimonial__items--desc">Mum ut perspiciatis unde omnis iste
                                                    natus ganu
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items">
                                            <div class="testimonial__items--topbar d-flex align-items-center">
                                                <div class="testimonial__items--thumbnail">
                                                    <img class="testimonial__items--thumbnail__img display-block"
                                                        src="{{ asset('themes') }}/client/img/other/testimonial-thumb2.webp"
                                                        alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__items--author">
            ...
            <div class="container-fluid">
                <div class="newsletter__banner--thumbnail position__relative">
                    <img class="newsletter__banner--thumbnail__img display-block"
                        src="{{ asset('themes') }}/client/img/banner/banner-bg2.webp" alt="newsletter-banner">
                                ...
                                <div class="blog__items">
                                    <div class="blog__thumbnail">
                                        @if ($item->img_path)
                                            <a class="blog__thumbnail--link display-block" href="blog-details.html"><img
                                                    ...
                                                    src="{{ Storage::url($item->img_path) }}" width="409px"
                                                    height="409px" alt="blog-img"></a>
                                        @endif
                                    </div>
                                    <div class="blog__content">
                                        ...
                                        <h3 class="blog__content--title h4"><a
                                                href="blog-details.html">{{ $item->title }}</a></h3>
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkF3TLBTT7"><img
                                        ...
                                        src="{{ asset('themes') }}/client/img/other/instagram1.webp" alt="instagram-img">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkF60sBxhN"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('themes') }}/client/img/other/instagram2.webp" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
                                            <defs>
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkF90ZB6HG"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('themes') }}/client/img/other/instagram3.webp" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
                                            <defs>
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkGAe6BQeu"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('themes') }}/client/img/other/instagram4.webp" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
                                            <defs>
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkGCWcBbv9"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('themes') }}/client/img/other/instagram5.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkGFDMhoid"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('themes') }}/client/img/other/instagram6.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkGGnyh7jZ"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('themes') }}/client/img/other/instagram7.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkF3TLBTT7"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('themes') }}/client/img/other/instagram1.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199"
                                            viewBox="0 0 25.198 25.199">
