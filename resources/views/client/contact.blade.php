            ...
            <div class="col">
                <div class="breadcrumb__content">
                    ...
                    <ul class="breadcrumb__content--menu d-flex">
                        ...
                        <li class="breadcrumb__content--menu__items"><span class="text-white">Liên hệ với chúng tôi</span></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="contact__section section--padding">
    <div class="container">
        <div class="section__heading mb-40">
            ...
            <p class="contact__section--hrading__desc">Nếu bạn có thắc mắc gì xin hãy nhắn cho chúng tôi để nhận được phản hồi nhanh nhất <br> ELEGANT-HOME sẵn sàng lắng nghe bạn!</p>
        </div>
                        ...
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">Thay đổi thiết kế thông qua một phạm vi <br> <a href="tel:+01234-567890">0368309192</a> hoặc <a href="tel:++01234-5688765">0942121812</a>   </p>
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">  <br> <a href="mailto:info@example.com">Elegant-home@gmail.com</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">  P. Hàm Nghi, Đơn Nguyên 2, Nam Từ Liêm, Hà Nội.</p>
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
...
<div class="contact__map--area section--padding pt-0">
    <iframe class="contact__map--iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d23895.834688057224!2d105.74504397867567!3d21.031030632904177!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454c7521d2d91%3A0xba6cdc3e1406ddfe!2zQ2F1IERpZW4sIFThu6sgTGnDqm0sIEhhbm9pLCBWaWV0bmFt!5e0!3m2!1sen!2s!4v1728374848580!5m2!1sen!2s" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
