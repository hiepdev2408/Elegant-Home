        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="index.html">
                    <img src="{{ asset('themes') }}/client/img/logo/nav-log.webp" alt="Furea Logo">
                </a>
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumbnail">
                    <a href="product-details.html"><img src="{{ asset('themes') }}/client/img/product/product1.webp"
                            alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumbnail">
                    <a href="product-details.html"><img src="{{ asset('themes') }}/client/img/product/product2.webp"
                            alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
