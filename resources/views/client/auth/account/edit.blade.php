            ...
            <div class="col-6">
                <div class="sidebar">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('profile.edit', $user->id) }}">
                    ...
                    <form action="{{ route('profile.update', $user->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="smember_info">
                            ...
                            <div class="form-group"style="margin-top: 10px">
                                ...
                                <input class="contact__form--input" type="text" name="address"
                        ...
                        <button type="submit" class="contact__form--btn primary__btn" style="margin-top: 10px">Cập
                            nhật</button>
                    </form>
                </div>
            </div>
