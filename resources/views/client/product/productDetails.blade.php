                                ...
                                <div class="swiper-container thumbs-carousel">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide mb-5">
                                            <figure class="thumb">
                                                <img src="{{ Storage::url($gallery->img_path) }}" style="height: 100px" alt="Thumbnail sản phẩm">
                                            </figure>
                                        </div>
                                        @endif
                                        @endforeach
                    ...
                    <div class="content-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="price">
                                ...
                                <span class="new-price">{{ isset($finalPrice) && $finalPrice > 0 ? number_format($finalPrice, 0, ',', '.') : number_format($product->price_sale, 0, ',', '.') }} VNĐ</span>
                                @else
                                <span class="old-price new-price">{{ number_format($product->base_price, 0, ',', '.') }} VNĐ</span>
                                @endif
                            </div>
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                @php
                                $data = ['id' => $attribute->attributeValue->id, 'name' => $attribute->attributeValue->value];
                                ...
                                <div class="d-grid flex-wrap attribute-container">
                                    ...
                                    <div class="attribute-group">
                                        ...
                                        <div class="select-size-box d-flex flex-wrap">
                                            <select name="variant_attributes[attribute_value_id][]" class="form-select attribute-select me-3" data-attribute-name="{{ $attributeName }}">
                                                @foreach ($values as $value)
                                                <option value="{{ $value['id'] }}">{{ Str::limit($value['name'], 30) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="button-box">
                                    ...
                                    <input type="hidden" name="total_amount" value="{{ isset($finalPrice) ? $finalPrice : ($product->price_sale ?? $product->base_price) }}">
                                    <button type="submit" class="theme-btn btn-style-one">Add to cart</button>
                                </div>

                                <div class="quantity-box d-flex align-items-center" style="gap: 0.5rem; padding: 0.5rem; border: 1px solid #ccc; border-radius: 8px; background-color: #f9f9f9;">
                                    <label for="quantity" style="font-size: 1rem; font-weight: 500;">Quantity:</label>
                                    <input type="number" id="quantity" name="quantity" min="1" value="1" style="width: 60px; padding: 0.25rem; border-radius: 4px; border: 1px solid #ccc;">
                                </div>
                            </div>
                        </div>
                    </div>
