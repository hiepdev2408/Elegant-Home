                    ...
                    <div class="row h-100">
                        <div class="col-5">
                            <div class="d-flex align-items-end h-100 justify-content-center">
                                <img src="{{ asset('themes') }}/admin/img/illustrations/illustration-3.png"
...
@section('script-libs')
    ...
    <script src="{{ asset('themes') }}/admin/vendor/libs/%40form-validation/umd/bundle/popular.min.js"></script>
    <script src="{{ asset('themes') }}/admin/vendor/libs/%40form-validation/umd/plugin-bootstrap5/index.min.js"></script>
    <script src="{{ asset('themes') }}/admin/vendor/libs/%40form-validation/umd/plugin-auto-focus/index.min.js"></script>
    <script src="{{ asset('themes') }}/admin/js/app-access-roles.js"></script>
    <script src="{{ asset('themes') }}/admin/js/modal-add-role.js"></script>
@endsection
