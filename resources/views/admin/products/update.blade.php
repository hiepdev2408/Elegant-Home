                                    ...
                                    <div class="variant mb-4" id="variant_{{ $variantIndex }}">
                                        ...
                                        <div class="form-group">
                                            <label for="variant_price_modifier_{{ $variantIndex }}">Giá điều
                                                chỉnh:</label>
                                            <input  type="number"
                                                name="variants[{{ $variant->id }}][price_modifier]" class="form-control"
...
@section('script-libs')
    ...
    <script>
        document.getElementById('add-gallery').addEventListener('click', function() {
            ...
            const galleryCount = galleryContainer.children.length + 1; // Tăng số lượng gallery

            // Tạo div mới cho gallery
            const newGalleryDiv = document.createElement('div');
            newGalleryDiv.id = `gallery_new_${galleryCount}`;
    ...
    `;
            ...
            // Thêm div mới vào gallery container
